  ...
  const fetchData = async () => {
    ...
    try {
      if(sidbarInfo.apiUrls[apiKey]?.apiUrl){
        ...
        const rVol_recent = response.data["recent data"]["r_phase_voltage"];
        const yVol_recent = response.data["recent data"]["y_phase_voltage"];
        const bVol_recent = response.data["recent data"]["b_phase_voltage"];
